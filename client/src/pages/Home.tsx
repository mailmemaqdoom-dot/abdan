...
import { buildWhatsAppUrl, openRazorpayCheckout } from "@/lib/payment";
...
export default function Home() {
  ...
  async function handleRazorpayPayment() {
    const total = totals.total || Number(selectedProduct?.priceLabel.replace(/[^\d]/g, "") || 0);
    setPaying(true);
    const result = await openRazorpayCheckout(total);
    setPaying(false);
            ...
            {isBagCheckoutVisible ? (
              <div className="payment-suite bag-payment-suite">
                <div className="payment-block">
                  ...
                  <button className="luxury-primary full-width" onClick={handleRazorpayPayment} disabled={isPaying}>
                  ...
                  <a
                    href={buildWhatsAppUrl(
                      `Hello, I have completed payment via UPI.\n\nPlease confirm my order.\n\n${bagCheckoutMessage}`,
                    )}
                    target="_blank"
                    rel="noreferrer"
